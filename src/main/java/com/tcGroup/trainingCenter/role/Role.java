...
@AttributeOverrides({
        @AttributeOverride(name="auditCD",
                column=@Column(name="ROL_AUDIT_CD")),
        @AttributeOverride(name="auditCU",
                column=@Column(name="ROL_AUDIT_CU")),
        @AttributeOverride(name="auditMD",
                column=@Column(name="ROL_AUDIT_MD")),
        @AttributeOverride(name="auditMU",
                column=@Column(name="ROL_AUDIT_MU")),
        @AttributeOverride(name="auditRD",
                column=@Column(name="ROL_AUDIT_RD")),
        @AttributeOverride(name="auditRU",
                column=@Column(name="ROL_AUDIT_RU"))
})
@Data
